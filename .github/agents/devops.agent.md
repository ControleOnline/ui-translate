---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-translate, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-translate`.
...
- Checkout local: `app-community/modules/controleonline/ui-translate`
